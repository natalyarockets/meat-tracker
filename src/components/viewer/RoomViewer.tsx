        ...
        <div className="order-2 lg:order-1">
          ...
          <div className="mt-4 glass-panel p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>• Start your backend: <code className="bg-secondary px-1 rounded">uvicorn beam:app --reload</code></li>
              <li>• Drag to rotate the view, scroll to zoom</li>
              <li>• Upload your .glb room scan</li>
              <li>• Place Phone (transmitter) and Laptop (receiver) markers</li>
              <li>• Click "Calibrate" when area is clear</li>
              <li>• Walk between devices to trigger detection!</li>
            </ul>
          </div>
        </div>
